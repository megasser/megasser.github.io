...
var w3c_slidy = {
  ...
  // find schedule URL from meta element
  find_schedule: function () {
    var name, url;
    var meta = document.getElementsByTagName("meta");
  ...
  add_toolbar: function () {
    var counter, page;
     ...
     if (this.ns_pos || !this.ie6)
     {
       ...
       var schedule = this.find_schedule();
       if (schedule)
	 {
	     var schedtoolbar = this.create_element("a");
             schedtoolbar.setAttribute("href", schedule);
             schedtoolbar.setAttribute("title", this.localize("class schedule"));
	     schedtoolbar.innerHTML = this.localize("schedule?");
	     left.appendChild(schedtoolbar);
	 }
